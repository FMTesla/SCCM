...
# Reset BITS and WU servie to the default descriptor
...
# shutdown /f /r /t 144000 /c "Your computer needs to restart within 4 hours to repair the Update service. We apologize for any inconvenience."